...
const Hero: FC = (): ReactElement => {
    return (
        <section className='relative'>
            <Image src='/hero_bg.jpg' alt='hero_bg_img' width={1500} height={400} className='absolute z-[-1] w-full max-h-[400px]' />
            <div className='container mx-auto max-w-[885px] flex pt-[85px] pb-[100px]'>
                ...
                <div className='basis-1/2'>
                    <Image src='/credit_card.jpg' alt='card' width={340} height={215} />
                </div>
            </div>
        </section>
    );
